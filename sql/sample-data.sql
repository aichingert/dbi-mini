...
-- Employee | 9
INSERT INTO EMPLOYEE (EMPLOYEEID, BRANCHID, NAME, WAGE, POSITION) VALUES (0, 1, 'former employee', 0, 'unemployed');
...
-- Bill | 10
INSERT INTO BILL (EMPLOYEEID, BRANCHID, CUSTOMERID, DATEOFISSUE) VALUES (1, 1, 1, TO_DATE('2023-09-01', 'YYYY-MM-DD'));
INSERT INTO BILL (EMPLOYEEID, BRANCHID, CUSTOMERID, DATEOFISSUE) VALUES (3, 3, 2, TO_DATE('2023-09-03', 'YYYY-MM-DD'));
INSERT INTO BILL (EMPLOYEEID, BRANCHID, CUSTOMERID, DATEOFISSUE) VALUES (2, 2, 3, TO_DATE('2023-09-02', 'YYYY-MM-DD'));
INSERT INTO BILL (EMPLOYEEID, BRANCHID, CUSTOMERID, DATEOFISSUE) VALUES (4, 1, 4, TO_DATE('2023-09-04', 'YYYY-MM-DD'));
INSERT INTO BILL (EMPLOYEEID, BRANCHID, CUSTOMERID, DATEOFISSUE) VALUES (5, 2, 5, TO_DATE('2023-09-05', 'YYYY-MM-DD'));
INSERT INTO BILL (EMPLOYEEID, BRANCHID, CUSTOMERID, DATEOFISSUE) VALUES (6, 3, 6, TO_DATE('2023-09-06', 'YYYY-MM-DD'));
INSERT INTO BILL (EMPLOYEEID, BRANCHID, CUSTOMERID, DATEOFISSUE) VALUES (7, 1, 7, TO_DATE('2023-09-07', 'YYYY-MM-DD'));
INSERT INTO BILL (EMPLOYEEID, BRANCHID, CUSTOMERID, DATEOFISSUE) VALUES (8, 2, 1, TO_DATE('2023-09-08', 'YYYY-MM-DD'));
INSERT INTO BILL (EMPLOYEEID, BRANCHID, CUSTOMERID, DATEOFISSUE) VALUES (9, 3, 2, TO_DATE('2023-09-09', 'YYYY-MM-DD'));
INSERT INTO BILL (EMPLOYEEID, BRANCHID, CUSTOMERID, DATEOFISSUE) VALUES (1, 1, 3, TO_DATE('2023-09-10', 'YYYY-MM-DD'));
